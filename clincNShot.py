...
class ClincNShot:
    ...
    def __init__(self, root, filename, batchsz, n_way, k_shot, k_query, embedsz, path='clinc_labse.npy'):
        """
        ...
        if not os.path.isfile(os.path.join(root, path)):
            ...
            temp = dict()  # {intent:embed1, embed2..., 100 embeds, intent2: embed1, embed2,... in total, 150 intents}
            ...
            # each character containns 20 imgs
        ...
        self.x_train, self.x_test = self.x[:120], self.x[120:]
        ...
        for sample in range(10):  # num of episodes
            ...
            for i in range(self.batchsz):  # one batch means one set
                ...
                for j, cur_class in enumerate(selected_cls):
                    ...
                    selected_img = np.random.choice(100, self.k_shot + self.k_query, False)
